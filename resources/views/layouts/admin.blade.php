...
<head>
  ...
  <title>@yield('title', 'Admin Dashboard') — SmartSociety</title>
  ...
  <aside class="app-sidebar" id="adminSidebar">
    <div class="d-flex align-items-center gap-3 px-2 mb-4">
      ...
      <div>
        ...
        <span class="badge badge-neutral-custom" style="font-size: 0.68rem;">ADMIN PORTAL</span>
      </div>
    </div>
    ...
    <nav class="sidebar-nav flex-grow-1">
      ...
      <a class="nav-link {{ request()->routeIs('admin.flats.*') || request()->routeIs('admin.residents.*') ? 'active' : '' }}" href="{{ route('admin.flats.index') }}">
      ...
      <a class="nav-link {{ request()->routeIs('admin.gate-logs.*') ? 'active' : '' }}" href="{{ route('admin.gate-logs.index') }}">
        <i class="bi bi-shield-check"></i>
        <span>Security & Gate Logs</span>
      </a>
      <a class="nav-link {{ request()->routeIs('admin.emergency-alerts.*') ? 'active' : '' }}" href="{{ route('admin.emergency-alerts.index') }}">
      ...
      <div class="d-flex align-items-center justify-content-between p-2 rounded-3" style="background: rgba(255, 248, 240, 0.5);">
        <div class="d-flex align-items-center gap-2 overflow-hidden">
          ...
          <div class="text-truncate">
            ...
            <span class="text-muted d-block text-truncate" style="font-size: 0.72rem;">Administrator</span>
          </div>
        </div>
  ...
  <div class="main-wrapper">
    ...
    <header class="glass-panel app-navbar d-flex align-items-center justify-content-between">
      <div class="d-flex align-items-center gap-3">
        <button class="btn btn-sm d-lg-none p-0 border-0" type="button" onclick="document.getElementById('adminSidebar').classList.toggle('show')">
          <i class="bi bi-list fs-2" style="color: var(--primary-brand);"></i>
        </button>
        <h4 class="mb-0 font-heading fw-bold">@yield('page-title', 'Overview')</h4>
      </div>
        ...
        <div class="dropdown">
          <button class="btn p-0 border-0 d-flex align-items-center gap-2" type="button" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <div class="text-start d-none d-md-block">
              ...
              <span class="text-muted" style="font-size: 0.72rem;">Admin</span>
            </div>
            <i class="bi bi-chevron-down text-muted small"></i>
          </button>
          <ul class="dropdown-menu dropdown-menu-end glass-panel border-0 shadow-lg p-2" style="min-width: 200px;">
            <li><h6 class="dropdown-header text-muted small text-uppercase">Admin Account</h6></li>
