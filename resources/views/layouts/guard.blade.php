...
<head>
  ...
  <title>@yield('title', 'Gate Management') — SmartSociety Guard</title>
...
<body>
  ...
  <header class="glass-panel mx-3 my-3 p-3 d-flex align-items-center justify-content-between">
    <div class="d-flex align-items-center gap-3">
      <div class="brand-logo-icon" style="background: var(--dark-text);">
        <i class="bi bi-shield-lock-fill text-warning"></i>
      </div>
      <div>
        <h4 class="mb-0 font-heading fw-bold">SmartSociety Security Gate</h4>
        <span class="badge badge-warning-custom" style="font-size: 0.7rem;"><i class="bi bi-broadcast me-1"></i> GATE STATION ACTIVE</span>
      </div>
    </div>
    ...
    <div class="d-flex align-items-center gap-3">
      ...
      <div class="text-start d-none d-md-block">
        ...
        <span class="text-muted" style="font-size: 0.72rem;">Security Guard</span>
      </div>
